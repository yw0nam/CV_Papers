...
Title | Contributions | Code | Review | Recommand |
--- | --- | --- | --- | --- |
Generative Adversarial Networks(2014 NIPS)[[pdf]](https://arxiv.org/abs/1406.2661) |
<ul><il> Propose adversarial network | [code](https://github.com/eriklindernoren/PyTorch-GAN) | :star::star::star::star::star: |
